...
app.post('/verifyClient', async (req, res) =>
{
    ...
    console.log(req.body.Cloud_region)
    const clientInteracting = await queryConversationDetails(req.body.Telefone, req.body.AccessToken, req.body.Cloud_region[0])
